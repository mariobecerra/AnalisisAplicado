...
% función de Doblez, como programada en clase
% iPad y Trigo
function [ p ] = Doblez( B, grad, delta )
% Se obtiene una p-direccn al prob Trust Region por el método Doblez
% es decir, dentro de una bola de tamaño delta, la mejor direccn
    pN = B\-grad; % Newton
